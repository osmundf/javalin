...
public class Javalin {
	...
	public Javalin start() {
		if (!started) {
			...
			try {
				...
				port = embeddedServer.start(hostName, port);
	...
	public String hostName() {
		return started ? this.hostName : "";
	}

	public Javalin hostName(String hostName) {
		ensureActionIsPerformedBeforeServerStart("Setting the host name");
